...
export const meta = {
  ...
  slug: 'tips-for-working-from-home',
...
I've recently transitioned into a new work from home job. I've never done remote work before, so during my interviews I asked friends who worked from home what they did to maintain a good work-ethic. This is a small mixture of what they said as well as some findings of my own.
...
If you are living with others, try to create a way for the other members of the household to know if you're interruptible or not. For my wife and kids, if my office door is open it means I can be interrupted. When I go into a meeting or need some concentration time, I close my door. It's simple and works out great for myself. 

For a more automated solution, a friend of mine created a Mac app called [On Air](https://getonair.app/?ref=buddyreno) to adjust LifX and Wyze devices (and soon Philips Hue) to alert his family when his availability changed. Talk with your housemates and come up with a solution that is easy to follow through with.

## Don't neglect meaningful interactions

Whether you intend to make friends at work or not, there's people you see everyday that you talk to about work, music, movies, games, etc. When you're working remotely, that interaction is less natural and requires more effort. Talk to people on slack/teams (or whatever your company uses) and get to know people! You don't have to tell your life story but shared hobbies and interests can develop new friendships. 
